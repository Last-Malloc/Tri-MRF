...
class TACoS(data.Dataset):
    ...
    def __init__(self, split):
        ...
        # tacos stoi 1514个词 str->int 'PAD':0 'UNK':1513
        with open(os.path.join(self.data_dir, 'words_vocab_tacos.json'), 'r') as f:
        ...
        print(f'name:TACoS split:{split} max_sent_len:{max_sent_len}')
    ...
    def __getitem__(self, index):
        ...
        # word_label: 使用tacos字典(1514) str->int
